...
def random_feature_sparsity(splitted_data: dict, processed_dir: str, client_id: int, mask_prob: float=0.1):
...
def random_label_sparsity(splitted_data: dict, processed_dir: str, client_id: int, percentage=0.1):
    mask_filename = osp.join(processed_dir, "mask", f"random_label_mask_{percentage:.2f}_client_{client_id}.pt")
...
def random_label_noise(splitted_data: dict, processed_dir: str, client_id: int, percentage: float=0.1):
    noise_filename = osp.join(processed_dir, "noise", f"random_label_noise_{percentage:.2f}_client_{client_id}.pt")
